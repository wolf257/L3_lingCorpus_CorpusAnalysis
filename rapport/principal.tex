...
% \fancyhead[args]{valeur} % définition en-tete
% \fancyfoot[args]{valeur} % définition pied de page
% Arg opt pour les deux : E, O for page's parity (even or odd)
% R, L, C : right, left or center

%\renewcommand{\headrulewidth}{...pt} % epaisseur trait horizontal en dessous de l’en-tête
%\renewcommand{\footrulewidth}{1pt} % epaisseur trait horizontal au dessus pied de page

%--\renewcommand{\chaptermark}[1]{\markboth{#1}{}}

\fancyhead[L]{}%Section  : \thesection ~ ...}%{Part : \thepart ~ Chap : \thechapter} % définition en-tête
%\fancyhead[R]{\leftmark} % définition en-tête
...
\input{chap/objectifs}

%-------------------------------------------------------------------
	\chapter{Organisation des dossiers et du code}
\input{chap/organisation}

%ss forme de liste
%-------------------------------------------------------------------
	\chapter{Difficultés rencontrées}
\input{chap/difficultes}
